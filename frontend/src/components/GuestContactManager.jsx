...
/**
 * GuestContactManager Component
 * Provides UI for importing contacts from device phonebook
 */
const GuestContactManager = ({ onContactsImported }) => {
   ...
   * Opens the contact picker if supported
   */
  ...
  return (
    <div className="mb-6 p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md">
      ...
      <button
        ...
        disabled={isLoading}
        className="btn btn-primary w-full md:w-auto touch-manipulation"
      >
        {isLoading ? (
